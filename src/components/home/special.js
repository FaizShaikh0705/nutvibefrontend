  ...
  return (
    <>
      <section className={styles.productsec} style={{ padding: "50px 0" }}>
        <Container>
          <h2 className={` ${styles.ptitle} text-start mb-2 mb-md-3 fw-bold`}>Special Product's</h2>
          <h5 className={`${styles.subtitle} text-start mb-3 mb-md-4 fw-bold`}>Top - Special Product's</h5>
          <Row>
